...
3. The quorum is reset and:
   ...
   - The component with this node as a member will become the primary component

   - All nodes the component will synchronize to the most up-to-date node, and
