...
std::string const gcomm::Defaults::EvsConsensusTimeout      = "PT30S";
...
std::string const gcomm::Defaults::EvsSendWindow            = "8";
std::string const gcomm::Defaults::EvsSendWindowMin         = "1";
std::string const gcomm::Defaults::EvsUserSendWindow        = "1";
